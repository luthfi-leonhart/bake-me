package com.upwardproject.bakeme.ui.widget;
...
public abstract class EndlessRecyclerViewOnScrollListener extends RecyclerView.OnScrollListener {
     ...
     * for better UX
     */
    private int sVisibleThreshold = 2;
    ...
    public EndlessRecyclerViewOnScrollListener(RecyclerView.LayoutManager layoutManager) {
        ...
        if (layoutManager instanceof GridLayoutManager) {
            ...
            sVisibleThreshold = sVisibleThreshold * gridLayoutManager.getSpanCount();
        } else if (layoutManager instanceof StaggeredGridLayoutManager) {
            StaggeredGridLayoutManager staggeredGridLayoutManager = (StaggeredGridLayoutManager) layoutManager;
            sVisibleThreshold = sVisibleThreshold * staggeredGridLayoutManager.getSpanCount();
        }
    }
